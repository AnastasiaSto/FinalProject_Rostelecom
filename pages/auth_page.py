...
class AuthPage(BasePage):
    # TC_01 метод проверки перехода в форму авторизации
    ...
    # ТС_02 метод проверки расположения логотипа и слогана
    ...
    # ТС_03 метод проверки расположения меню выбора типа аутентификации
    def location_of_the_tab_menu(self):
        assert self.is_element_present(AuthPageLocators.AUTH_TAB_MENU), "element not found"

    # ТС_04 метод проверки типа аутентификации по умолчанию
    ...
    # ТС_05 метод проверки автоматического изменения типа аутентификации
    ...
    # ТС_06 метод проверки ссылки на форму восстановления пароля
    ...
    # ТС_07 метод проверки ссылки на форму регистрации
    ...
    # ТС_08 метод проверки ссылки на страницу с пользовательским соглашением под кнопкой "Войти"
    ...
    # ТС_09 метод проверки ссылки на страницу с пользовательским соглашением в футере
    ...
    # ТС_10 метод проверки ссылки на страницу авторизации с помощью соцсети "ВКонтакте"
    ...
    # ТС_11 метод проверки авторизации с незаполненными полями
    ...
    # ТС_12 метод проверки текстового поля на SQL-инъекции
