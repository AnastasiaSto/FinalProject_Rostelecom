...
class RegPage(BasePage):
    # ТС_21 метод проверки расположения полей ввода, кнопки "Зарегистрироваться", ссылки на пользовательское соглашение
    ...
    # ТС_22 метод проверки валидности текстового поля (ввод валидных данных)
    ...
    # ТС_23 метод проверки валидности поля ввода email или мобильного телефона (ввод валидных данных)
    ...
    # ТС_24 метод проверки валидности поля ввода пароля (ввод валидных данных)
    ...
    # ТС_25 метод проверки регистрации с валидными данными
    ...
    # ТС_26 метод проверки ссылки под кнопкой "Зарегистрироваться" на страницу с пользовательским соглашением
    ...
    # ТС_27 метод проверки ссылки на страницу с пользовательским соглашением в футере
    ...
    # ТС_28 метод проверки валидности текстового поля (ввод невалидных данных)
    ...
    # ТС_29 метод проверки валидности поля ввода email или мобильного телефона (ввод невалидных данных)
    ...
    # ТС_30 метод проверки валидности поля ввода пароля (ввод невалидных данных)
    ...
    # ТС_31 метод проверки заполнения поля подтверждения пароля данными, отличными от введенных в поле ввода пароля
    ...
    # ТС_32 метод проверки регистрации с невалидными данными
