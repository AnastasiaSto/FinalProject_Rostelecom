...
class ChangePassPage(BasePage):
    # ТС_13 метод проверки типа восстановления пароля по умолчанию
    ...
    # ТС_14 метод проверки валидности поля ввода номера телефона/почты/логина/лицевого счета (ввод валидного номера)
    ...
    # ТС_15 метод проверки валидности поля ввода номера телефона/почты/логина/лицевого счета (ввод валидного email)
    ...
    # ТС_16 метод проверки кнопки перехода в форму авторизации
    ...
    # ТС_17 метод проверки ссылки на страницу с пользовательским соглашением в футере
    ...
    # ТС_18 метод проверки восстановления пароля с незаполненными полями
    ...
    # ТС_19 метод проверки восстановления пароля с незаполненным значением капчи
    ...
    # ТС_20 метод проверки текстового поля на SQL-инъекции
